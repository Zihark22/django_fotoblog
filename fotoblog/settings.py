...
SECRET_KEY = 'django-insecure-z=9kg)t$xmz8z2$7mrfl%lp)d33y5vru4uztb2=q0ws*32l%8-'
...
LOGIN_URL = 'login' # page pour redirection si l'utilisateur souhaite accéder à une page à laquelle il doit être connecté
LOGIN_REDIRECT_URL = 'home'
LOGOUT_REDIRECT_URL = LOGIN_URL

# Folder to save images for the blog (only for local dev)
MEDIA_URL = '/media/'
